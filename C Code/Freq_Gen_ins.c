...
volatile unsigned int aa = 0;
volatile unsigned int bb = 0;
int start = 0;
unsigned int sigsta[5] = { 0,1,1,1,0 };
unsigned int sigleft[5] = { 0,1,0,0,1 };
unsigned int sigright[5] = { 0,1,0,1,0 };
unsigned int sigforward[5] = { 1,1,0,0,1 };
unsigned int sigbackward[5] = { 1,0,0,1,1 };
unsigned int highspeed[5] = { 1,0,1,0,1 };
unsigned int lowspeed[5] = { 0,1,0,1,1 };
...
void main (void)
{
	...
	{	
		...
		if (start == 1) {
			...
			else if (stringequ(instruction, sigleft) == 1) {
				aa = 15;
				bb = 85;
			}
