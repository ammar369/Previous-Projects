...
jnb START_STOP, stop
jnb INC_STATE, increment_state_redirect		;if the INC_STATE button is pressed we jump to the next state, in this case, the system completes its process and goes to state0
clr c
subb a, temp
jc state5_done
mov state, #0
